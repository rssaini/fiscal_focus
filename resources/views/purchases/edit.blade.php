    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1>Edit Purchase Record: {{ $purchase->rec_no }}</h1>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('datetime') is-invalid @enderror"
                                           name="datetime" value="{{ old('datetime', $purchase->datetime->format('Y-m-d\TH:i')) }}" required>
                                    @error('datetime')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('mines_id') is-invalid @enderror"
                                        ...
                                        @foreach($mines as $mine)
                                            <option value="{{ $mine->id }}" {{ old('mines_id', $purchase->mines_id) == $mine->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('rec_no') is-invalid @enderror"
                                                   name="rec_no" value="{{ old('rec_no', $purchase->rec_no) }}" required
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('token_no') is-invalid @enderror"
                                                   name="token_no" value="{{ old('token_no', $purchase->token_no) }}" required
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('driver') is-invalid @enderror"
                                        ...
                                        <option value="{{ $purchase->driver }}" selected>{{ $purchase->driver }}</option>
                                    </select>
                                    @error('driver')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('gross_wt') is-invalid @enderror"
                                                   name="gross_wt" id="gross_wt" value="{{ old('gross_wt', $purchase->gross_wt) }}" required
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('tare_wt') is-invalid @enderror"
                                                   name="tare_wt" id="tare_wt" value="{{ old('tare_wt', $purchase->tare_wt) }}" required
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="net_wt" value="{{ $purchase->net_wt }}" readonly
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="wt_ton" value="{{ $purchase->wt_ton }} Tons" readonly
                                                   placeholder="Auto calculated">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('commission') is-invalid @enderror"
                                           name="commission" value="{{ old('commission', $purchase->commission) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('use_at') is-invalid @enderror"
                                        ...
                                        <option value="manufacturing" {{ old('use_at', $purchase->use_at) == 'manufacturing' ? 'selected' : '' }}>Manufacturing</option>
                                        <option value="stock" {{ old('use_at', $purchase->use_at) == 'stock' ? 'selected' : '' }}>Stock</option>
                                    </select>
                                    @error('use_at')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                ...
                <div class="card">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Update Purchase Record
                        </button>
                        <a href="{{ route('purchases.index') }}" class="btn btn-secondary">
