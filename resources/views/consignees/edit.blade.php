    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Consignee: {{ $consignee->consignee_name }}</h4>
                    <div class="d-flex gap-2">
                        <a href="{{ route('consignees.show', $consignee) }}" class="btn btn-outline-info">
            ...
            <div class="card-body">
                <form action="{{ route('consignees.update', $consignee) }}" method="POST" id="consigneeForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('gstin') is-invalid @enderror"
                                   id="gstin" name="gstin"
                                   value="{{ old('gstin', $consignee->gstin) }}"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror"
                                      ...
                                      placeholder="Enter street address">{{ old('address', $consignee->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('address2') is-invalid @enderror"
                                      ...
                                      placeholder="Additional address information (optional)">{{ old('address2', $consignee->address2) }}</textarea>
                            @error('address2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('city') is-invalid @enderror"
                                   id="city" name="city"
                                   value="{{ old('city', $consignee->city) }}" required
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('state') is-invalid @enderror"
                                   id="state" name="state"
                                   value="{{ old('state', $consignee->state) }}" required
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('zip') is-invalid @enderror"
                                   id="zip" name="zip"
                                   value="{{ old('zip', $consignee->zip) }}" required
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror"
                                ...
                                <option value="active" {{ old('status', $consignee->status) == 'active' ? 'selected' : '' }}>Active</option>
                                <option value="inactive" {{ old('status', $consignee->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('consignees.show', $consignee) }}" class="btn btn-secondary">
                                    <i class="fas fa-times"></i> Cancel
                                </a>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update Consignee
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <p><strong>Created:</strong> {{ $consignee->created_at->format('M d, Y g:i A') }}</p>
                        <p><strong>Last Updated:</strong> {{ $consignee->updated_at->format('M d, Y g:i A') }}</p>
                    </div>
                    <div class="col-md-6">
                        <p><strong>Consignee ID:</strong> #{{ $consignee->id }}</p>
                        <p><strong>Sales Count:</strong> {{ $consignee->sales_count }}</p>
                    </div>
                </div>
            </div>
        </div>
